...
export const CreatePost = () => {
  ...
  return (
    <section className="separate max-w-7xl mx-auto ">
      <div>
      ...
      <form action="" className="blue-separate mt-16">
        <div>
          <FormField
            labelName="Your Name"
            type="text"
          ...
          focus:ring-[#4649ff] focus:border-[#4649ff] w-64 p-3 h-64 flex justify-center items-center"
          >
            {form.photo ? (
              <img
                src={form.photo}
